...
# First Attempt
	...
	echo "<b><span># ACTIVATE FILE COOKIE HANDLING (assign local file with read and write permission)</span></b>\r\n";
	echo "<b>\$curl->set_opt(array('CURLOPT_COOKIEFILE' => '{$file}', 'CURLOPT_COOKIEJAR' => '{$file}'));</b>\r\n";
	$curl->set_opt(array('CURLOPT_COOKIEFILE' => $file, 'CURLOPT_COOKIEJAR' => $file));
	echo "\r\n";

	echo "<b><span># SENDING HTTP GET REQUEST TO URL (redirection from http to https is expected)</span></b>\r\n";
	...
	echo "<b><span># VALID VARIABLE EXTRACTED FROM RESPONSE HEADER (useful when a header variable is required for additional processing)</span></b>\r\n";
	...
	echo "<b><span># COOKIE FILE CONTENT (cookie file may not be updated unless \$curl->close() is called)</span></b>\r\n";
	echo "<b>\$curl->get_cookie();</b>\r\n";
	echo "<div>".file_get_contents($file)."</div>\r\n";
	echo "</fieldset>\r\n";
